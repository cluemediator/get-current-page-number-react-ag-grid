...
function App() {
  ...
  return (
    <div className="App">
      <h2>Get the current page number in AG Grid - <a href="https://www.cluemediator.com" target="_blank">Clue Mediator</a></h2>
      <button className='btn-action' onClick={handleBtnAction}>Get Current Page</button>
